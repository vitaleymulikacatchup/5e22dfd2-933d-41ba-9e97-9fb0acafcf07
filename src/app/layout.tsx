...
export const metadata: Metadata = {
  title: "NASA Space Missions - Exploring the Final Frontier",
  description: "Discover NASA's incredible space missions, from Apollo to Mars exploration. Meet the team, explore spacecraft, and learn about humanity's journey to the stars.",
  keywords: "NASA, space missions, astronauts, spacecraft, Mars exploration, Apollo program, space station, rocket launches",
  metadataBase: new URL("https://images.pexels.com/photos/34521/space-shuttle-lift-off-liftoff-nasa.jpg"),
  alternates: {
    canonical: "https://images.pexels.com/photos/34521/space-shuttle-lift-off-liftoff-nasa.jpg"
  },
  openGraph: {
    title: "NASA Space Missions - Exploring the Final Frontier",
    description: "Journey through NASA's groundbreaking space missions and discover humanity's greatest achievements in space exploration.",
    siteName: "NASA Missions",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/34521/space-shuttle-lift-off-liftoff-nasa.jpg",
        alt: "NASA space shuttle launch"
      }
    ]
  },
  twitter: {
    ...
    title: "NASA Space Missions - Exploring the Final Frontier",
    description: "Journey through NASA's groundbreaking space missions and discover humanity's greatest achievements in space exploration.",
    images: ["https://images.pexels.com/photos/34521/space-shuttle-lift-off-liftoff-nasa.jpg"]
  },
  robots: {
    index: true,
    follow: true
